...
ward = AgglomerativeClustering(linkage='average', connectivity = connectivity)
...
plt.title('SAT Clustering Dendrogram structured by inverse function')
plot_dendrogram(ward, leaf_font_size = 12)
plt.savefig('SAT_Clustering_Dendrogram_structured_by_inverse_function.png')
plt.show()
